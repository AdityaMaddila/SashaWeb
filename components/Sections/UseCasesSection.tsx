...
function UseCaseCard({ icon, title, description }: UseCaseCardProps) {
  return (
    ...
    >
      <Card className="h-full shadow-md hover:shadow-lg transition-all duration-300 border-gray-700 dark:border-yellow-900/50 backdrop-blur-xl
bg-grey/10
bg-grey/15
bg-grey/20
border-white/15
border-white/20
border-white/30 group-hover:bg-gradient-to-br group-hover:from-gray-800 group-hover:to-gray-900 dark:group-hover:from-[rgba(251,147,11,0.1)] dark:group-hover:to-gray-900">
